var Data = {
  ...
  AboutOverview:"Jake Muller is a Southern New York Full-stack Engineer. Who is customer focused, results oriented, and utilizes talents and expertise in an environment to achieve client focused results and satisfaction.<strong> Believeing that client satisfaction and needs comes first.</strong> Acheieveing said results and satisfaction through both professinal experience and self determination. While also realizing a career in this industry revolves around continued learning and education.<br>  Now serving in Warwick NY, MiddleTown NY, North Carolina, and Florida. He specializes in Data-Driven, Mobile, Front and Back-end Technologies.",
  ...
  About:["./img/about.jpg", "./img/me2.jpeg", "About", "Jake Muller", ""],
  Projects:["https://wallpaperaccess.com/full/1947423.jpg","./img/me3.jpg", "Projects", "by Jake Muller", ""],
  Contact:["./img/backgroundMain.jpg","./img/me3.jpg", "Jake Muller", "Request Estimate Or Information", ""],
  ...
  achievementsPics:["./img/gems1.png","./img/gem2.png"],
  ...
  skills:[{"label":"Web-Technologies" , "data":[
          "Eight Year's Experience using JavaScript",
          "JavaScript Frameworks- Multiple (JQuery, Angular, React)",
          "Eight Year's Experience in HTML + CSS",
          "Five Year's Experience with Bootstrap",
          "One Year's Experience Node.js - Mobile Apps to Server",
          "Five Year's Experience in PHP - Server-Side Scripting and SQL database calls and Security management",
          "Eight Year's Experience SQL - Creating, Overseeing and Maintaining Client Databases ",
          "Five Year's Experience Asp.Net - Creating in developing back-end web services, APIs, And front end websites and dashboards.",]},
    {"label":"Mobile App Technologies" , "data":[
        "Five Year's Experience in Java/Android Studio- Created Multiple Android Apps",
        "Four Year's Experience with Swift - Created Multiple IOS Apps",
        "Two Year's Experience AWS - Developing and Maintain Client Servers and Databases (AWS Aroura, AWS Instances)",
        "Five Year's Experience C# - creating multiple web applications, implementing databases and developing multiple web servers and mobile projects. Have a multitude of experience doing many different things in this language.",
  ...
  ProjectsData : [{"Image":"./img/gh.png","Title":"Garnet Health Mobile App","Code":"https://github.com/JakeLMuller/GhApp", "ContentSmall":"Supported on both Android, IOS and Ipad",
           ...
           "Content":"Garnet Health Mobile App is a mobile solution for patients to view their medical information. The App utilizes integrations from Epic's MyChart for paitents to scheduale appointments, chat with doctors, pay bills and view their medical records. Newest Version of the app is linked below", "Color":"ghostwhite", "Link":"https://apps.apple.com/us/app/garnet-health/id1556106944"},
          ...
          "Content":"Garnet Health Policies and Procedures is a content management system for policies over three hospitals and multiple doctor offices. This Application allows for users to upload a policy and set metadata including concurrers and approvers. Each concurrer has to approve the policy before moving on to the next step. Once the final approval is finished the policy become live and is followed by each department. The app filters each policy by department, category and location. Access to viewing/editing each policy is department based and an administration page is used to set and edit access. The app also features fully developed messaging and custom emails that are sent out based on user activity. The app was developed by myself as the only developer and took 3 months to finish. The backend is in C#, .Net and MsSql, while the front end is in Javascript, HTML and CSS. The app is an internal tool for Garnet health and not able to be viewed but a copy of the source code is linked below.", "Color":"ghostwhite", "Link":"private"},

          {"Image":"./img/gh.png","Title":"Garnet Health Intranet","Code":"https://github.com/JakeLMuller/GHIntranet/tree/main/WebApplication3", "ContentSmall":"Desktop Supported, Fully Responsive, and Mobile Supported","Platforms":["Web"], "OpenSource":"Yes",
